...
export function findAll(agente_id?: string, status?: string): CasoPayload[] {
...
export function findById(id: string): CasoPayload | undefined {
    return casos.find(caso => caso.id === id);
}

export function searchCasos(query: string): CasoPayload[] {
...
export function create(caso: CasoPayload): CasoPayload {
    casos.push(caso);
    return caso;
}

export function update(id: string, updatedCaso: CasoPayload): CasoPayload | undefined {
...
export function partialUpdateCaso(id: string, updatedCaso: Partial<CasoPayload>): CasoPayload | undefined {
